<!-- Modified version from https://github.com/Chocobozzz/PeerTube/blob/develop/SECURITY.md -->
...
- Perform testing only on in-scope systems, and respect systems and activities which are out-of-scope. Systems currently considered in-scope are the official demonstration/test servers provided by the {{ ORGANIZATIONS }} development team.
...
The vulnerability is kept private until a majority of instances have updated to a safe version or applied a hotfix. The {{ ORGANIZATIONS }} development team coordinates efforts to update once the patch is issued.

## Official Channels

To help us receive vulnerability submissions we use the following official reporting channel:

- [GitHub advisories](https://github.com/{{ ORGANIZATIONS }}/{{ REPOSITORY_NAME }}/security/advisories/new)
